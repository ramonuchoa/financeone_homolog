<div class="row">
        <div class="col-md-6">
                <form class="FrmHistorico" action="{action}" method="post" accept-charset="utf-8">
                        ...
                        <div class="col-xs-2">
                                <input class="form-control" type="text" name="mes" maxlength="2" placeholder="Mes" />
                        </div>
        ...
        <div class="col-md-6">
                <form class="FrmHistorico" action="{action}" method="post" accept-charset="utf-8">
                        ...
                        <div class="col-xs-2">
                                <input class="form-control" type="text" name="mes_de" maxlength="2" placeholder="Mes" />
                        </div>
			...
			<br><br><br>
                        ...
                        <div class="col-xs-2">
                                <input class="form-control" type="text" name="mes_ate" maxlength="2" placeholder="Mes" />
                        </div>
