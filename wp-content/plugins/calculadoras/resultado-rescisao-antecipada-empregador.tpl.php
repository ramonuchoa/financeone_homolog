<div class="coluna-box">
    <p class="subtitulo-box">Rescisão pelo empregador</p>
    <h3>Salários</h3>
    <p>
    ...
    <p>
        ...
        Total de outros vencimentos: {valorPrazoRemanescente} <br />

        Parcela do INSS do empregador sobre outros vencimentos: {inssPrazoRemanescente} <br />
        IRPF sobre outros vencimentos: {irPrazoRemanescente} <br />
        <strong>Total de descontos sobre outros vencimentos: {totalDescontosPrazoRemanescente}</strong> <br />
    </p>
    <p>
        {linhaVencimentos}
        {linhaDescontos}
