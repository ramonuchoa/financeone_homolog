...
$url      = 'https://www.cma.com.br/informacaomercado/Indices.aspx?parceiro=CMA';
...
foreach ($descricoes as $key => $descricao) {
    $indicador[$indicadoresArr[$key]]['descricao'] = utf8_encode($descricao->nodeValue);
}
...
$db->salvarIndicesMundiais($indicador);
